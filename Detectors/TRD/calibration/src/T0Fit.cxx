...
namespace o2::trd
{
  ...
  void T0Fit::initProcessing()
  {
    ...
    mFuncErfLandau = std::make_unique<TF1>("fErfLandau", [&](double* x, double* par) {return par[0]*TMath::Erf(x[0]) + par[1]*TMath::Landau(x[0],par[2],par[3]);}, mFitFunctor.lowerBoundFit, mFitFunctor.upperBoundFit, 4);
